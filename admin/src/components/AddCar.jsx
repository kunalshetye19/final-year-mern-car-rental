...
// FOR IMG HANDLING
  ...
  const renderInputField = (field) => (
    <div key = {field.name}>
      <label className={field.icon ? AddCarPageStyles.labelWithIcon: AddCarPageStyles.label}>
        {field.icon}
        {field.name}
      </label>
        ...
        <div className={AddCarPageStyles.formGrid}>
          ...
          <div className={AddCarPageStyles.formColumn}>
              ...
              <div>
                ...
                <div className={AddCarPageStyles.imageUploadContainer}></div>
                <label className={AddCarPageStyles.imageUploadLabel}>
                  {data.imagePreview ? (
                    <div className="w-full h-full rounded-x1 overflow-hidden">
                      <img
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="Provide a brief description of your car (optional)"
